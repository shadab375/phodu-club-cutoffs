...
export default function met() {
  ...
  const handleSubmit = () => {
    if (selectedOption === "cutoffs") {
      window.location.href = `${process.env.NEXT_PUBLIC_BASEURL}/josaa/cutoffs`;
    } else if (selectedOption === "predictor") {
      window.location.href = `${process.env.NEXT_PUBLIC_BASEURL}/josaa/predictor`;
    } else if (selectedOption === "versus") {
      window.location.href = `${process.env.NEXT_PUBLIC_BASEURL}/josaa/versus`;
    }
  };
    ...
    >
      <div className="text-white flex flex-col items-center justify-center flex-grow">
        ...
        >
          ...
          <option value="versus">JOSAA Marks vs Rank</option>
          <option value="predictor">JOSAA Branch Predictor</option>
          <option value="cutoffs">JOSAA Cutoffs</option>
        </select>
        <button
